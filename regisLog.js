document.addEventListener("DOMContentLoaded", function() {
    ...
    const regisLog = document.getElementById("regisLog");

    // Email validation
    function validateEmail(email) {
        return email.endsWith("@regis.edu");
    }
    ...
    regisLog.addEventListener("submit", function(event) {
        ...
        .then(data => {
            ...
            setTimeout(() => {
                window.location.href = "reis.html";
            }, 2000);
        })
        .catch(error => {
